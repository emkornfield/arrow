...
public class UInt2Vector extends BaseFixedWidthVector implements BaseIntVector {
   ...
   */
  public static char get(final ArrowBuf buffer, final long index) {
   ...
   */
  public char get(long index) throws IllegalStateException {
   ...
   * @param index   position of element
   */
  public void get(long index, NullableUInt2Holder holder) {
    if (isSet(index) == 0) {
      holder.isSet = 0;
      return;
    }
   ...
   * @return element at given index
   */
  public Character getObject(long index) {
    if (isSet(index) == 0) {
      return null;
    } else {
      return valueBuffer.getChar(index * TYPE_WIDTH);
  ...
  private void setValue(long index, char value) {
    valueBuffer.setChar(index * TYPE_WIDTH, value);
  }
   ...
   */
  public void set(long index, NullableUInt2Holder holder) throws IllegalArgumentException {
    if (holder.isSet < 0) {
   ...
   */
  public void set(long index, UInt2Holder holder) {
    BitVectorHelper.setValidityBitToOne(validityBuffer, index);
    setValue(index, holder.value);
  }
   ...
   * @param value   value of element
   */
  public void setSafe(long index, char value) {
    handleSafe(index);
    set(index, value);
  }
   ...
   * @param holder  nullable data holder for value of element
   */
  public void setSafe(long index, NullableUInt2Holder holder) throws IllegalArgumentException {
    handleSafe(index);
    set(index, holder);
  }
   ...
   * @param holder  data holder for value of element
   */
  public void setSafe(long index, UInt2Holder holder) {
    handleSafe(index);
    set(index, holder);
  }
   ...
   */
  public void set(long index, int isSet, char value) {
    if (isSet > 0) {
      set(index, value);
    } else {
      BitVectorHelper.setValidityBit(validityBuffer, index, 0);
   ...
   */
  public void setSafe(long index, int isSet, char value) {
    handleSafe(index);
